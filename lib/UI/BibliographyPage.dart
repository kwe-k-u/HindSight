        ...
        body: Container(
          ...
          children: [
            ...
            Text("Haiti: A Long Descent to Hell | World News | The Guardian. "
                ...
                "earthquake-disaster. Accessed 18 Nov. 2020."), //todo fix reference
            ...
            Text('Migeod, F. W. M. “A View of the Colony of Sierra Leone.” '
                'Journal of the African Society, vol. 25, no. 97, 1925, pp. 1–9,'
                ' https://www.jstor.org/stable/717063.'),

            Text('Morgan, Jennifer L. “Partus Sequitur Ventrem: Law, Race, and'
                ' Reproduction in Colonial Slavery.” Small Axe, vol. 22, no. 1, '
                '2018, pp. 1–17, doi:10.1215/07990537-4378888.'),

            Text('OWENS, DEIRDRE COOPER. “BLACK WOMEN’S EXPERIENCES IN SLAVERY '
                'AND MEDICINE.” Medical Bondage, University of Georgia Press, 2018,'
                ' pp. 42–72, doi:10.2307/j.ctt1pwt69x.7.'),

            Text('Pritting, Shannon. “Book Review: Governments Around the World:'
                ' From Democracies to Theocracies.” Reference & User Services'
                ' Quarterly, vol. 55, no. 4, 2016, p. 325, doi:10.5860/rusq.55n4.325a.'),

            Text('Quarles, Benjamin. “Lord Dunmore as Liberator.” The William and '
                'Mary Quarterly, vol. 15, no. 4, 1958, p. 494, doi:10.2307/2936904.'),
            ...
            Text('Vanderford, Chad. “Declarations of Independence: Slavery,'
                ' Secession, and the Confederate Scapegoat.” Tennessee Historical '
                'Quarterly, vol. 70, no. 2, 2011, pp. 92–107. JSTOR, www.jstor.org/'
                'stable/42628746. Accessed 29 Oct. 2020.'),
          ],
          ),
        ),
      ),
